...
const Footer = () => {
    const loc = <FontAwesomeIcon icon={faMapMarker}></FontAwesomeIcon>
            ...
            <Container>
              <Row>
                    <Col xs className="text-start">
                       ...
                       <Col xs>{loc} Karnafuli, Chittagong, Bangladesh</Col>
                       <Col xs>{mbl} Mobile: +880 1849648291</Col>
                       <Col xs>{mail} Email: abc@gmail.com</Col>
                    </Col>
                    <Col xs className="text-start">
